...
<img src="{{ asset('images/500.png') }}" class="mx-auto mt-n5 col-10 col-sm-8 col-md-6" style="margin: auto;"  alt="erreur 500">

<h1 class="text-uppercase mt-0 title" style="font-family: 'Balsamiq Sans', cursive;z-index:10"><br><strong style="font-weight:bold!important"> Erreur 500</strong></h1>
