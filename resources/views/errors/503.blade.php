...
<img src="{{ asset('images/404.webp') }}" class="mx-auto mt-n5 col-12 col-sm-8 col-md-6" style="margin: auto;"  alt="erreur 404">

<h1 class="text-uppercase mt-n5 title" style="font-family: 'Balsamiq Sans', cursive;z-index:10"><br><strong style="font-weight:bold!important"> Article indisponible</strong></h1>
