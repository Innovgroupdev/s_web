...
@section('ref')
    ...
    <link rel="canonical" href="{{ url('/la-politique-de-confidentialite') }}" />
    <meta name="keywords"
    ...
    <meta property="og:url" content="{{ url('/la-politique-de-confidentialite') }}">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "{{url('/la-politique-de-confidentialite')}}",
            "logo": "{{ asset("
            ...
            <div class="row">
                ...
                <div class="col-md-6 align-self-center">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">la-politique-de-confidentialite</li>
                    </ul>
                </div>
            </div>
        ...
        <div class="py-2 px-0 px-sm-2">
            ...
            <div style="line-height:200%;" class="">
                <p>
                    ...
                    indiquée : <a
                        href="https://www.cible-app.com/la-politique-de-confidentialite">https://www.cible-app.com/la-politique-de-confidentialite</a>
                    .
