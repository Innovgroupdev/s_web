...
@section('content')
    ...
    <div class="tab-content py-3 px-5 shadow-lg text-center" id="nav-tabContent">
        <div class="tab-pane fade text-dark show active " id="nav-apprenant" role="tabpanel"
            ...
            <div class="row mt-- py-2 px-0 px-sm-2">
                ...
                <div class="container col-12 col-lg-7 pl-0 px-4 px-sm-6">
                    ...
                    <div style="line-height:200%;" class="text-left">
                        <p class="h6">
                            ...
                            <a href=""> (Téléchargement CIBLE PRO)</a> créent leurs comptes professionnels qui est
                            validé par
                            ...
                            étape par étape. Une fois l’événement publié, l’administration vérifie son authenticité puis le
                            valide pour qu’il soit affiché au grand public sur l’application mobile CIBLE <a
                                href="">téléchargeable
                                gratuitement</a>. Une fois l’événement publié, l’organisateur peut modifier les informations
                            de son
                            événement et les participants seront notifiés. Il peut reporter ou annuler l’événement. En cas
                ...
                <div class="col-4 pl-5 d-none d-lg-block pt-md-5 pt-xl-0">
                    <img src="{{ url('images/annonce.svg') }}" class="my-auto mt-md-5 mt-xl-0" alt="functionnality"
                        style="width:100%" />
                </div>
            </div>
            ...
            <div class="row mt-5 py-2 px-0 px-sm-2">
                ...
                <div class="container col-12 col-lg-7 pl-0 px-4 px-sm-6">
                    ...
                    <h3 class="text-lg-right text-uppercase titre2" style="font-weight: bold!important">
                        <br><strong style="font-weight: bold!important">Vente et Achat de tickets événementiels au « Togo »
                        </strong>
                    </h3><br>
                    <div class="col-10 col-md-8 mx-auto d-block d-lg-none mt-3 mb-5">
                        <img src="{{ url('images/deal.svg') }}" class="my-auto mt-md-5 mt-xl-0" alt="functionnality"
                    ...
                    <div style="line-height:200%;" class="text-left">
                        <p class="h6" style="line-height:200%;">
                            ...
                            internautes sur <a href="">l’application CIBLE</a> de pourvoir acheter le type de ticket
                            qu’ils désirent. Au
                            moment de la création de l’événement sur <a href="">CIBLE PRO</a>, il est demandé les
                            types de tickets
                            disponibles, les quantités disponibles pour chaque type. L’organisateur peut donc suivre depuis
                            son compte l’évolution des ventes de tickets et les statistiques liées aux ventes. A la création
                            ...
                            Pour acheter un ticket pour un événement, il faut au préalable recharger son portefeuille depuis
                            son <a href="">compte CIBLE</a> puis il suffira de choisir le type et la quantité depuis
                            la page qui présente
                            l’événement. Une facture est générée avec le total à payer. Une fois validée, votre portefeuille
                            est décompté et vous pouvez voir ce qui vous reste sur votre portefeuille.<br />
                            Pour les organisateurs, une facture est générée pour servir de justificatif comptable des ventes
            ...
            <div class="row mt-- py-2 px-0 px-sm-2">
                <div class="container col-12 col-lg-7 pl-0 px-4 px-sm-6">
                    ...
                    <div style="line-height:200%;" class="text-left">
                        <p class="h6" style="line-height:200%;">
                            Cette fonctionnalité est disponible sur <a href="">l’application CIBLE</a>. Pour acheter
                            les tickets en toute
                            tranquillité et ne pas avoir à renseigner leurs moyens de paiement à chaque fois, nous avons
                            développé une fonctionnalité pour permettre à nos utilisateurs de charger une fois un montant de
                            leur choix. Ainsi, pour tous les tickets qu’ils achètent, nous décomptons leur portefeuille
                            jusqu’à ce que celui-ci soit épuisé. Une fois le portefeuille épuisé, l’utilisateur recharge de
                            nouveau le montant de son choix et ainsi de suite. Vous avez la possibilité de recharger votre
            ...
            <div class="row mt-- py-2 px-0 px-sm-2">
                ...
                <div class="container col-12 col-lg-7 pl-0 px-4 px-sm-6">
                    ...
                    <h3 class="text-lg-right text-uppercase titre2" style="font-weight: bold!important">
                        <br><strong style="font-weight: bold!important">Commande des gadgets souvenirs pour vos événements
                            coup de cœur
                        </strong>
                    </h3><br>
                    <div class="col-10 col-md-8 mx-auto d-block d-lg-none mt-3 mb-5">
                    ...
                    <div style="line-height:200%;" class="text-left">
                        <p class="h6" style="line-height:200%;">
                            Une fois que vous achetez votre ticket pour un événement, il vous est demandé si vous aimeriez
                            obtenir un gadget souvenir pour immortaliser votre participation à l’événement… Si vous êtes
                            intéressé, on vous propose donc les gadgets (liste des gadgets) disponibles pour votre événement
                            et vous choisissez ceux que vous voulez et la quantité de votre choix. Notez que les gadgets ne
                            seront pas disponibles pour tous les événements. <br />
                            Des frais symboliques des gadgets seront ajoutés à votre facture des tickets puis le total sera
            ...
            <div class="row mt-- py-2 px-0 px-sm-2">
                <div class="container col-12 col-lg-7 pl-0 px-4 px-sm-6">
                    <h3 class="text-lg-left text-uppercase titre2" style="font-weight: bold!important">
                        <br><strong style="font-weight: bold!important">Participation aux enquêtes de satisfaction après
                            chaque événement
                        </strong>
                    </h3><br>
                    <div class="col-10 col-md-8 mx-auto d-block d-lg-none mt-3 mb-5">
                    ...
                    <div style="line-height:200%;" class="text-left">
                        <p class="h6" style="line-height:200%;">
                            Vous avez acheté votre ticket sur CIBLE pour participer à un événement ; une fois l’événement
                            passé, nous générons une enquête de satisfaction de voir ce que vous avez aimé et ce que vous
                            n’avez pas aimé. Vous aurez donc des options de réponses pour chaque question et vous aurez
                            juste à cocher les réponses qui vous conviennent. Cela nous permettra de donner les meilleures
                            recommandations aux organisateurs d’événements afin que ceux-ci fassent de chaque événement à
            ...
            <div class="row mt-- py-2 px-0 px-sm-2">
                ...
                <div class="container col-12 col-lg-7 pl-0 px-4 px-sm-6">
                    ...
                    <div style="line-height:200%;" class="text-left">
                        <p class="h6" style="line-height:200%;">
                            Une application <a href="">CIBLE SCAN</a> est aussi disponible pour permettre de scanner
                            les tickets achetés
                            sur CIBLE. Pour éviter la fraude, tous les tickets générés par scan sont reconnus par
                            l’application CIBLE SCAN qui est le scanner des tickets achetés sur <a
                                href="">l’application CIBLE</a>. Cette
                            ...
                            CIBLE, alors, le ticket est validé et accepté et si le ticket n’est pas reconnu, alors il est
                            ...
                            L’organisateur pourra donc communiquer le code à ceux qui sont chargés de vérifier la véracité
                            des tickets à l’entrée. Les statistiques de scan des tickets sont affichées à l’organisateur
                            afin qu’il ait une idée des tentatives de fraude lors de son événement et le nombre de personnes
