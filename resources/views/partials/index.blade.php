								...
								<div class="container">
									<div class="sf-content">
										<div id="home" data-vc-full-width="true" data-vc-full-width-init="false"
											...
											data-vc-parallax-image="{{ asset('wp-content/uploads/sites/9/2019/02/bg-1-1.jpg')}}"
											...
											<div class="wpb_column vc_column_container vc_col-sm-12">
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
															...
															<div class="container">
																<div class="banner-text">
																	<div class="row flex-row-reverse">
																		<div
																			class="col-sm-5 col-lg-5 col-md-5 hidden-xs">
																			<div class="img-one">
																				<img class="iq-mobile-img"
																					src="{{ asset('wp-content/uploads/sites/9/2019/02/banner-2-1.png')}}"
																					alt="#">
																			</div>
																		</div>
																		<div
														...
														<div class="iq-background-overlay overlay3"
															id="overlay_96900610"></div>
														<div class="layer_wrap iq-objects-style-1 "
															id="object_2103496286"><span class="iq-objects-01"
																data-bottom="transform:translatey(100px)"
																data-top="transform:translatex(0);">
																<img src="{{ asset('wp-content/uploads/sites/9/2019/02/w-1-1.png')}}"
																	alt="drive02">
													...
													<div class="wpb_wrapper">
														...
														<div class="vc_row wpb_row vc_inner vc_row-fluid">
																...
																<div class="vc_column-inner">
																	<div class="wpb_wrapper">
																		<div class="iq-fancy-box text-"><img alt="fancy"
																				src="{{ asset('wp-content/uploads/sites/9/2019/02/1-1.png')}}" />
															...
															<div
																...
																<div class="vc_column-inner">
																	<div class="wpb_wrapper">
																		<div class="iq-fancy-box text-"><img alt="fancy"
																				src="{{ asset('wp-content/uploads/sites/9/2019/02/2-1.png')}}" />
															...
															<div
																...
																<div class="vc_column-inner">
																	<div class="wpb_wrapper">
																		<div class="iq-fancy-box text-"><img alt="fancy"
																				src="{{ asset('wp-content/uploads/sites/9/2019/02/3-1.png')}}" />
															...
															<div class="vc_column-inner">
																<div class="wpb_wrapper">
																	<div class="iq-fancy-box text-"><img alt="fancy"
																			src="{{ asset('wp-content/uploads/sites/9/2019/02/clible-app-usage-icone.png')}}" />
														...
														<div
															...
															<div class="vc_column-inner">
																<div class="wpb_wrapper">
																	<div class="iq-fancy-box text-"><img alt="fancy"
																			src="{{ asset('wp-content/uploads/sites/9/2019/02/clible-app-plus-event-icone.png')}}" />
														...
														<div
															...
															<div class="vc_column-inner">
																<div class="wpb_wrapper">
																	<div class="iq-fancy-box text-"><img alt="fancy"
																			src="{{ asset('wp-content/uploads/sites/9/2019/02/clible-app-a-propos-icone.png')}}" />
												...
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														<div
															...
															<div
																class="no-margin wpb_column vc_column_container vc_col-sm-6">
																<div class="vc_column-inner">
																	<div class="wpb_wrapper">
																		<div
																			...
																			<figure class="wpb_wrapper vc_figure">
																				<div
																					...
																					<img width="604" height="615"
																						src="{{ asset('wp-content/uploads/sites/9/2019/02/sc-1-1.png')}}"
																						class="vc_single_image-img attachment-full"
																						alt="" loading="lazy"
																						srcset="{{ asset('wp-content/uploads/sites/9/2019/02/sc-1-1.png')}} 604w, {{ asset('wp-content/uploads/sites/9/2019/02/sc-1-1-295x300.png')}} 295w, {{ asset('wp-content/uploads/sites/9/2019/02/sc-1-1-600x611.png')}} 600w"
																						sizes="100vw" /></div>
																			</figure>
																		</div>
																		<div class="layer_wrap iq-objects-style-2 "
																			id="object_1959149622"><span
																				class="iq-objects-01"
																				data-bottom="transform:translatey(200px)"
																				data-top="transform:translatex(0);">
																				<!-- <img src="wp-content/uploads/sites/9/2019/02/b3-1.png"
																					alt="drive02"> -->
																			</span><span class="iq-objects-02"
																				data-bottom="transform:translatey(-200px)"
																				data-top="transform:translatex(-0);">
																				<!-- <img src="wp-content/uploads/sites/9/2019/02/b1-1.png"
																					alt="drive02"> -->
																			</span></div>
																	</div>
																</div>
																...
																<div class="vc_column-inner">
																	<div class="wpb_wrapper">
																		...
																		<div class="button-position text-left">
																			<a style='' class="button " data-toggle="modal" data-target="#exampleModalCenter"
																				href="#screenshots">Soyez informé au lancement </a>
																		</div>
																	</div>
																</div>
															</div>
																	...
																	<div class="wpb_wrapper">
																		...
																		<ul class="iq-list">
																			<li> <i aria-hidden="true"
																					...
																					style=''></i> <span>Possibilité d’acheter vos tickets sans dépenser votre argent</span></li>
																			<li> <i aria-hidden="true"
																					class="ion ion-android-done-all"
																					style=''></i> <span>Des cadeaux (gadgets) personnalisés à chaque événement 
                                                                                    </span></li>
																			<li> <i aria-hidden="true"
																					class="ion ion-android-done-all"
																					style=''></i> <span>	Minimisez vos charges organisationnelles et gagnez plus</span></li>
																			<li> <i aria-hidden="true"
																					class="ion ion-android-done-all"
																					style=''></i> <span>Bénéficiez des enquêtes de satisfaction</span></li>
																			<li> <i aria-hidden="true"
																					class="ion ion-android-done-all"
																					style=''></i> <span>Gagnez du temps et minimisez vos déplacements</span></li>
                                                                                    <li> <i aria-hidden="true"
																					class="ion ion-android-done-all"
																					style=''></i> <span>Un système de vérification de tickets simple et gratuit</span></li>
                                                                                    <li> <i aria-hidden="true"
																					class="ion ion-android-done-all"
																					style=''></i> <span>Vivez votre événement en présentiel et en ligne…</span></li>
                                                                                    <li> <i aria-hidden="true"
																					class="ion ion-android-done-all"
																					style=''></i> <span>Recrutez les acteurs de l’événementiel en quelques minutes</span></li>
																		</ul>
																			...
																			<figure class="wpb_wrapper vc_figure">
																				<div
																					...
																					<img width="543" height="680"
																						src="{{ asset('wp-content/uploads/sites/9/2019/02/sc-2-1.png')}}"
																						class="vc_single_image-img attachment-full"
																						alt="" loading="lazy"
																						srcset="{{ asset('wp-content/uploads/sites/9/2019/02/sc-2-1.png')}} 543w, {{ asset('wp-content/uploads/sites/9/2019/02/sc-2-1-240x300.png')}} 240w"
																						sizes="100vw" /></div>
																			</figure>
																		</div>
																		<div class="layer_wrap iq-objects-style-3 "
																			id="object_443663318"><span
																				class="iq-objects-01"
																				data-bottom="transform:translatey(-200px)"
																				data-top="transform:translatex(-0);">
																				<!-- <img src="wp-content/uploads/sites/9/2019/02/b3-1.png"
										...
										<div data-vc-full-width="true" data-vc-full-width-init="false"
											...
											data-vc-parallax-image="{{ asset('wp-content/uploads/sites/9/2019/02/bg-2-1.jpg')}}"
																...
																<div class="vc_column-inner">
																	<div class="wpb_wrapper">
																		<div
																			...
																			<img class="img-fluid center-block img-fluid center-block " style="border-radius:10px"
																				src="{{ asset('wp-content/uploads/sites/9/2019/02/bg-3-1.jpg')}}"
																				alt="#">
																				...
																				<div
																					...
																					<div class="tab-content"
																						...
																						<div class="tab-pane fade show active"
																							id="tab11"><img
																								src="{{ asset('wp-content/uploads/sites/9/2019/02/s-1-1.png')}}"
																						...
																						<div class="tab-pane fade show "
																							id="tab22"><img
																								src="{{ asset('wp-content/uploads/sites/9/2019/02/s-4-1.png')}}"
																								class="img-fluid center-block img-fluid center-block "
																								alt="#"></div>
																						...
																						<div class="tab-pane fade show "
																							id="tab13"><img
																								src="{{ asset('wp-content/uploads/sites/9/2019/02/s-2-1.png')}}"
																								class="img-fluid center-block img-fluid center-block "
																								alt="#"></div>
																						...
																						<div class="tab-pane fade show "
																							id="tab24"><img
																								src="{{ asset('wp-content/uploads/sites/9/2019/02/s-5-1.png')}}"
																								class="img-fluid center-block img-fluid center-block "
																								alt="#"></div>
																						...
																						<div class="tab-pane fade show "
																							id="tab15"><img
																								src="{{ asset('wp-content/uploads/sites/9/2019/02/s-3-1.png')}}"
																								class="img-fluid center-block img-fluid center-block "
																								alt="#"></div>
																						...
																						<div class="tab-pane fade show "
																							id="tab26"><img
																								src="{{ asset('wp-content/uploads/sites/9/2019/02/s-6-1.png')}}"
																								class="img-fluid center-block img-fluid center-block "
																								alt="#"></div>
																	...
																	<div class="wpb_wrapper">
																		<div class="home-screen-slide">
																			<div class="owl-carousel popup-gallery"
																				...
																				data-margin="30">
																				<div class="item"><a
																						href="{{ asset('wp-content/uploads/sites/9/2019/02/s-4-1.png')}}"
																						class="popup-img"><img
																							class="img-fluid"
																							src="{{ asset('wp-content/uploads/sites/9/2019/02/s-4-1.png')}}"
																							alt="#"></a></div>
																				<div class="item"><a
																						href="{{ asset('wp-content/uploads/sites/9/2019/02/s-6-1.png')}}"
																						class="popup-img"><img
																							class="img-fluid"
																							src="{{ asset('wp-content/uploads/sites/9/2019/02/s-6-1.png')}}"
																							alt="#"></a></div>
																				<div class="item"><a
																						href="{{ asset('wp-content/uploads/sites/9/2019/02/s-5-1.png')}}"
																						class="popup-img"><img
																							class="img-fluid"
																							src="{{ asset('wp-content/uploads/sites/9/2019/02/s-5-1.png')}}"
																							alt="#"></a></div>
																				<div class="item"><a
																						href="{{ asset('wp-content/uploads/sites/9/2019/02/s-3-1.png')}}"
																						class="popup-img"><img
																							class="img-fluid"
																							src="{{ asset('wp-content/uploads/sites/9/2019/02/s-3-1.png')}}"
																							alt="#"></a></div>
																				<div class="item"><a
																						href="{{ asset('wp-content/uploads/sites/9/2019/02/s-2-1.png')}}"
																						class="popup-img"><img
																							class="img-fluid"
																							src="{{ asset('wp-content/uploads/sites/9/2019/02/s-2-1.png')}}"
																							alt="#"></a></div>
																				<div class="item"><a
																						href="{{ asset('wp-content/uploads/sites/9/2019/02/s-1-1.png')}}"
																						class="popup-img"><img
																							class="img-fluid"
																							src="{{ asset('wp-content/uploads/sites/9/2019/02/s-1-1.png')}}"
																							alt="#"></a></div>
																					...
																					<div class="iq-client white-bg">
																						<div class="client-img">
																							<img alt="#"
																								...
																								src="{{ asset('wp-content/uploads/sites/9/2019/01/test2-1.jpg')}}">
																						</div>
																						<div class="client-name">
																							<h6>Amy</h6><span
																								class="sub-title">CEO,Appino</span>
																						</div>
																				...
																				<div class="item">
																					<div class="iq-client white-bg">
																						<div class="client-img">
																							<img alt="#"
																								class="img-fluid rounded-circle"
																								src="{{ asset('wp-content/uploads/sites/9/2019/01/test1-1.jpg')}}">
																						</div>
																						<div class="client-name">
																							<h6>John Deo</h6><span
																								class="sub-title">CEO,Appino</span>
																				...
																				<div class="item">
																					<div class="iq-client white-bg">
																						<div class="client-img">
																							<img alt="#"
																								class="img-fluid rounded-circle"
																								src="{{ asset('wp-content/uploads/sites/9/2019/01/test3-1.jpg')}}">
																						</div>
																						<div class="client-name">
																							<h6>Jason</h6><span
																								class="sub-title">CEO,Appino</span>
																				...
																				<div class="owl-carousel pr-0"
																					...
																					<div class="team" style="border-right:1px solid #e3e3e3;">
																						<div class="image mx-auto">
																							...
																							class="img-fluid center-block img-fluid center-block  mx-auto" style="aspect-ratio:1;width:14rem;border-radius:50%" alt="">
																							<h5 class="mt-3">La Diva</h5>
																							<p
																								class="team-post text-secondary" >Chargé de la communication digitale </p>
																								<p
																					...
																					<div class="team" style="border-right:1px solid #e3e3e3;">
																						<div class="image mx-auto">
																							<img src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-le-geek.png')}}"
																							class="img-fluid center-block img-fluid center-block bg-secondary  mx-auto" style="aspect-ratio:1;width:14rem;border-radius:50%" alt="">
																							<h5 class="mt-3">Le Geek</h5>
																							<p
																								class="team-post text-secondary" >Développeur Front-End</p>
																								<p
																								class="team-post text-secondary" >
																								<span class="font-bold text-dark h2">
																									"
																					...
																					<div class="team" style="border-right:1px solid #e3e3e3;">
																						<div class="image mx-auto">
																							<img src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-le-saint.png')}}"
																							class="img-fluid center-block img-fluid center-block  mx-auto" style="aspect-ratio:1;width:14rem;border-radius:50%" alt="">
																							<h5 class="mt-3">Le Saint </h5>
																							<p
																								class="team-post text-secondary" >	Développeur Back-End	 </p>
																								<p
																								class="team-post text-secondary" >
																								<span class="font-bold text-dark h2">
																									"
																					...
																					<div class="team" style="border-right:1px solid #e3e3e3;">
																						<div class="image mx-auto">
																							<img src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-zeus.png')}}"
																							class="img-fluid center-block img-fluid center-block  mx-auto" style="aspect-ratio:1;width:14rem;border-radius:50%" alt="">
																							<h5 class="mt-3">Zeus</h5>
																							<p
																								class="team-post text-secondary" >Chargé de la communication</p>
																								<p
																								class="team-post text-secondary" >
																								<span class="font-bold text-dark h2">
																									"
																					...
																					<div class="team" style="border-right:1px solid #e3e3e3;">
																						<div class="image mx-auto">
																							<img src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-el-professor.png')}}"
																							class="img-fluid center-block img-fluid center-block  mx-auto" style="aspect-ratio:1;width:14rem;border-radius:50%" alt="">
																							<h5 class="mt-3">El Professor </h5>
																							<p
																								class="team-post text-secondary" >Chargé de la Relation Client </p>
																								<p
																								class="team-post text-secondary" >
																								<span class="font-bold text-dark h2">
																									"
																					...
																					<div class="team" style="border-right:1px solid #e3e3e3;">
																						<div class="image mx-auto">
																							<img src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-aigle.png')}}"
																							class="img-fluid center-block img-fluid center-block  mx-auto" style="aspect-ratio:1;width:14rem;border-radius:50%" alt="">
																							<h5 class="mt-3">L’aigle </h5>
																							<p
																								class="team-post text-secondary" >Product Owner, Chargé de la stratégie </p>
																								<p
																								class="team-post text-secondary" >
																								<span class="font-bold text-dark h2">
																									"
										...
										<div data-vc-full-width="true" data-vc-full-width-init="false"
											data-vc-parallax="1.5"
											data-vc-parallax-image="{{ asset('wp-content/uploads/sites/9/2019/02/bg-3-1.jpg')}}"
																	...
																	<div class="wpb_wrapper">
																		<div class="text-center" style='color:#ffffff;'>
																			<div class="counter"> <i
																					...
																					aria-hidden="true"></i>
																				<span class="timer" data-to="1540"
																					data-speed="10000">1540</span>
																				<label
																					style='color:#ffffff;'>EVENEMENTS PUBLIES</label>
																			</div>
																		</div>
																	</div>
																</div>
																	...
																	<div class="wpb_wrapper">
																		<div class="text-center" style='color:#ffffff;'>
																			<div class="counter"> <i
																					...
																					aria-hidden="true"></i>
																				<span class="timer" data-to="2530"
																					data-speed="10000">2530</span>
																				<label
																					style='color:#ffffff;'>TICKETS VENDUS</label>
																			</div>
																		</div>
																	</div>
																</div>
																	...
																	<div class="wpb_wrapper">
																		<div class="text-center" style='color:#ffffff;'>
																			<div class="counter"> <i
																					...
																					aria-hidden="true"></i>
																				<span class="timer" data-to="8120"
																					data-speed="10000">8120</span>
																	...
																	<div class="wpb_wrapper">
																		<div class="text-center" style='color:#ffffff;'>
																			<div class="counter"> <i
																					...
																					aria-hidden="true"></i>
																				<span class="timer" data-to="1620"
																					data-speed="10000">1620</span>
																			...
																			<figure class="wpb_wrapper vc_figure">
																				<div
																					...
																					<img width="553" height="600"
																						src="{{ asset('wp-content/uploads/sites/9/2019/02/faq-1-1.png')}}"
																						class="vc_single_image-img attachment-full"
																						alt="" loading="lazy"
																						srcset="{{ asset('wp-content/uploads/sites/9/2019/02/faq-1-1.png')}} 553w, {{ asset('wp-content/uploads/sites/9/2019/02/faq-1-1-277x300.png')}} 277w"
																						sizes="100vw" /></div>
																			</figure>
																		</div>
																		<div class="layer_wrap iq-objects-style-3 "
																			id="object_51857065"><span
																				class="iq-objects-01"
																				data-bottom="transform:translatey(-200px)"
																				data-top="transform:translatex(-0);">
																				<!-- <img src="wp-content/uploads/sites/9/2019/02/b3-1.png"
																				...
																				<div class="iq-ad-details show"
																					...
																					<div class="row">
																						<!-- <div class="col-sm-3">
																							<img alt="#"
																								class="img-fluid"
																								src="{{ asset('wp-content/uploads/sites/9/2019/02/faq-1-150x150.jpg')}}" />
																			...
																			<div class="owl-carousel" data-dots="false"
																				...
																				<div class="item">
																					<div class="iq-blog-box">
																						<div
																							class="iq-blog-image clearfix">
																							<img src="{{ asset('wp-content/uploads/sites/9/2018/12/blog-1-26-1.jpg')}}"
																								class="img-fluid center-block imgBlog"
																								alt="blogimage0">
																						</div>
																				...
																				<div class="item">
																					<div class="iq-blog-box">
																						<div
																							class="iq-blog-image clearfix">
																							<img src="{{ asset('wp-content/uploads/sites/9/2018/12/blog-2-26-1.jpg')}}"
																								class="img-fluid center-block imgBlog"
																								alt="blogimage1">
																						</div>
																						<div class="iq-blog-detail">
																							...
																							<div class="blog-button"><a
																									class="button"
																									href="2018/12/31/construction-industry-3/index.html">Voir plus<i
																										class="fa fa-angle-right"
																										aria-hidden="true"></i></a>
																							</div>
																						</div>
																				...
																				<div class="item">
																					<div class="iq-blog-box">
																						<div
																							class="iq-blog-image clearfix">
																							<img src="{{ asset('wp-content/uploads/sites/9/2018/12/blog-3-26-1.jpg')}}"
																								class="img-fluid center-block imgBlog"
																								alt="blogimage2">
																						</div>
																						<div class="iq-blog-detail">
																							...
																							<div class="blog-button"><a
																									class="button"
																									href="2018/12/31/build-construction-industry-2/index.html">Voir plus<i
																										class="fa fa-angle-right"
																										aria-hidden="true"></i></a>
																							</div>
																						</div>
																				...
																				<div class="item">
																					<div class="iq-blog-box">
																						<div
																							class="iq-blog-image clearfix">
																							<img src="{{ asset('wp-content/uploads/sites/9/2018/12/blog-4-26-1.jpg')}}"
																								class="img-fluid center-block imgBlog"
																								alt="blogimage3">
																						</div>
																						<div class="iq-blog-detail">
																							...
																							<div class="blog-button"><a
																									class="button"
																									href="2018/12/08/construction-industry-2/index.html">Voir plus<i
																										class="fa fa-angle-right"
																										aria-hidden="true"></i></a>
																							</div>
																						</div>
																				...
																				<div class="item">
																					<div class="iq-blog-box">
																						<div
																							class="iq-blog-image clearfix">
																							<img src="{{ asset('wp-content/uploads/sites/9/2018/12/blog-5-26-1.jpg')}}"
																								class="img-fluid center-block imgBlog"
																								alt="blogimage4">
																						</div>
																						<div class="iq-blog-detail">
																							...
																							<div class="blog-button"><a
																									class="button"
																									href="2018/12/08/life-lack-meaning-2/index.html">Voir plus<i
																										class="fa fa-angle-right"
																										aria-hidden="true"></i></a>
																							</div>
																						</div>
																				...
																				<div class="item">
																					<div class="iq-blog-box">
																						<div
																							class="iq-blog-image clearfix">
																							<img src="{{ asset('wp-content/uploads/sites/9/2018/12/blog-6-3-1.jpg')}}"
																								class="img-fluid center-block imgBlog"
																								alt="blogimage5">
																						</div>
																						<div class="iq-blog-detail">
																							...
																							<div class="blog-button"><a
																									class="button"
																									href="2018/12/08/life-lack-meaning/index.html">Voir plus<i
																										class="fa fa-angle-right"
																										aria-hidden="true"></i></a>
																							</div>
																						</div>
																	...
																	<div class="wpb_wrapper">
																		<div class="col-lg-12 col-md-12">
																			<div class="owl-carousel" data-dots="false"
																				...
																				data-margin="30">
																				<div class="item">
																					<img class="item partenaire"
																						src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-innov-is.jpg')}}"
																						alt="client0">
																				</div>
																				<div class="item">
																					<img class="item partenaire"
																						src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-procomdigit.png')}}"
																						alt="client1">
																				</div>
																				<div class="item">
																					<img class="item partenaire"
																						src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-asta.jpg')}}"
																						alt="client2">
																				</div>
																				<div class="item">
																					<img class="item partenaire"
																						src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-africa-visual-art.jpg')}}"
																						alt="client3">
																				</div>
																			...
																			<div class="col-lg-7">
																				<div class="text-center ">
																					<div class="widget_appino_widget">
																						<form method="post"
																							action="/"
																							class="appino-subscription"
																							id="appino_subscription">
																							<div class="email-form">
																								...
																								<div
																									...
																									<div
																										class="alax-loader">
																										<img alt=""
																											src="{{ asset('wp-content/plugins/appino-extensions/subscribers/ajax-loader.gif')}}"
																											style="display:none;"
																											id="loader"
																											class="loading" />
																									</div>
...
<div class="modal fade" id="exampleModalCenter1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenter1Title" aria-hidden="true">
                                            ...
                                            <div class="modal-content pt-0">
                                                ...
                                                <div class="modal-body text-center py-0 px-0" style="overflow : hidden">
                                                    <div class="container-fluid p-0 m-0" style="position:relative" >
                                                       <img src="{{ asset('wp-content/uploads/sites/9/2019/02/cible-app-modale-info.png')}}" class="container-fluid p-0 m-0" alt="" >
                                                        <!-- <div style="position:absolute;top:0;left:0;background: linear-gradient(to bottom, rgba(252, 119, 50, 0.5) 0%, rgba(236, 68, 86, 0.5) 100%);" class="w-100 h-100" ></div>
                                                        <img src="{{ asset("/wp-content/themes/appino/assets/images/logo.png")}}" style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:5rem" alt="">
                                                    </div> -->
                                                <div class="p-3">
                                                    ...
                                                    <div class="row my-4">
														<div class="col-12 mb-3">
                                                            <input id="nom" placeholder="Nom & prénom(s)"
                                                                name="nom" type="text" value="" size="30" maxlength="100"
                                                                aria-describedby="nom-notes" required='required' />
                                                        </div>
														<div class="col-12 mb-3">
                                                            <input id="email" placeholder="Email"
                                                                name="email" type="email" value="" size="30" maxlength="100"
                                                        ...
                                                        <div class="col-12 mb-3 ">
                                                            ...
                                                            <input id="profession" placeholder="Profession"
                                                                name="profession" type="text" value="" size="30" maxlength="100"
                                                                aria-describedby="profession-notes" required='required' />
                                                        </div>
