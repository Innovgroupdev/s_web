    ...
    @endif
                @if($articles->etat == 0)
                    {!! Form::model($articles, ['route' => ['etat', $articles->id], 'method' => 'patch', 'class' => 'desactive']) !!}
                        ...
                        <a type="submit" class="btn btn-info mx-1 py-3 px-5 btn-flat show_desactive d-flex" data-toggle="tooltip" title='Publier'>
                        ...
                        <a type="submit" class="btn btn-warning mx-1 py-3 px-5 btn-flat show_desactive" data-toggle="tooltip" title='Désactiver'>
                            Désactiver
                        </a>
                        {!! Form::close() !!}
                       @endif
