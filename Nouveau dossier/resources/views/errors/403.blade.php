...
<img src="{{ asset('images/403.jpg') }}" class="mx-auto mt-n5 col-12 col-sm-8 col-md-6 " style="margin: auto;"  alt="erreur 403">

<h1 class="text-uppercase mt-n5 title" style="font-family: 'Balsamiq Sans', cursive;z-index:10"><br><strong style="font-weight:bold!important"> Erreur 403</strong></h1>
