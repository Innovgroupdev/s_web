...
<img src="{{ asset('images/408.gif') }}" class="mx-auto mt-n5 col-12 col-sm-8 col-md-5" style="margin: auto;"  alt="erreur 408">

<h1 class="text-uppercase mt-0 title" style="font-family: 'Balsamiq Sans', cursive;z-index:10"><br><strong style="font-weight:bold!important"> Erreur 408</strong></h1>

<p style="font-size: 25px;font-weight:300;font-family: 'Montserrat', sans-serif;" class="subtitle">
  Le delai de votre demande à éxpiré
</p>
