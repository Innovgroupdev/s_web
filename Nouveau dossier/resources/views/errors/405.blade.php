...
<img src="{{ asset('images/405.png') }}" class="mx-auto mt-n5 col-12 col-sm-8 col-md-4" style="margin: auto;"  alt="erreur 405">

<h1 class="text-uppercase mt-0 title" style="font-family: 'Balsamiq Sans', cursive;z-index:10"><br><strong style="font-weight:bold!important"> Erreur 405</strong></h1>
